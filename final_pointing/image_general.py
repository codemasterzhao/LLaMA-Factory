...
def evaluate_model(category_name, model_name, input_json_path, model_series, evaluate_output_path):
    ...
    for idx, item in enumerate(input_data):
        ...
        for format in ["direct", "cot"]:
            ...
            print(f"Evaluating item {idx + 1}/{len(input_data)}: {item.get('id', idx)}")
...
if __name__ == "__main__":
    ...
    # input_json_path = "general_object_pointing_official.json"
    ...
    ## category_name = "pointing"

    # model_series: gemini, gpt, claude
    ...
    evaluate_output_path = f"final_gemini_{model_name}_evaluate_{evaluate_category}.json"
    evaluate_model(category_name, model_name, input_json_path, model_series, evaluate_output_path)